...
def process_data(p_incident, p_types, p_genders,p_status,p_age_groups,p_file_name,p_debug):
    ...
    print("")
    print("Participant Type process Started : "+ str(dt_string))
...
# *********************************************************************************************************** #
    ...
    print("")
    print("All processes completed : "+ str(dt_string))
...
# *********************************************************************************************************** #
    ...
    print("")
    print("CSV write started : "+ str(dt_string))
